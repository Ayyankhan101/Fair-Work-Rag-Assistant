# GitHub - pinchtab/pinchtab: High-performance browser automation bridge and multi-instance orchestrator with advanced stealth injection and real-time dashboard. · GitHub

> Source: https://github.com/pinchtab/pinchtab
> Cached: 2026-07-27T19:50:25.944Z

---

[](/pinchtab/pinchtab/blob/main/assets/pinchtab-headless.png)
  ...
  **Browser control for AI agents**
  ...
  Small Go binary • HTTP API • Token-efficient
      ...
      [](https://github.com/pinchtab/pinchtab/releases/latest)

      [](https://github.com/pinchtab/pinchtab/actions/workflows/ci-go.yml)

      [](https://camo.githubusercontent.com/bcf780e3087ef801eb9de3c04f558684341739228f2e435e92cd3340878d658a/68747470733a2f2f696d672e736869656c64732e696f2f62616467652f476f2d312e32352b2d3030414444383f7374796c653d666c61742d737175617265266c6f676f3d676f266c6f676f436f6c6f723d7768697465)

      [](/pinchtab/pinchtab/blob/main/LICENSE)
...
See the full guide: [docs/guides/security.md](/pinchtab/pinchtab/blob/main/docs/guides/security.md)
...
See [docs/audit.md](/pinchtab/pinchtab/blob/main/docs/audit.md) for the full command reference, report
...
- install the daemon or run `pinchtab server` for the full control plane
...
- install and start the daemon with `pinchtab daemon install`

- point your agent or tool at `http://localhost:9867`

- let PinchTab act as your local browser service
...
- **CloakBrowser support** — Optional drop-in provider for sites that fingerprint stock Chromium. PinchTab launches a user-supplied CloakBrowser binary; no CloakBrowser is bundled in released artifacts. See [docs/guides/cloakbrowser.md](/pinchtab/pinchtab/blob/main/docs/guides/cloakbrowser.md).
...
Basic Haiku (10 steps)
**9.5%**
23.0%
17.9%

Extended Haiku (24 steps)
**19.6%**
31.1%
26.2%

Extended Sonnet (24 steps)
**20.3%**
29.4%
25.3%
...
See the [benchmark summary](/pinchtab/pinchtab/blob/main/docs/benchmark.md) for an overview, or the
[benchmark deep dive](/pinchtab/pinchtab/blob/main/docs/deep-dive/benchmark.md) for full
...
curl -s -X POST http://localhost:9867/instances/sta
